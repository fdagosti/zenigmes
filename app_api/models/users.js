...
var userSchema = new mongoose.Schema({
    ...
    etablissement: {type: String, enum: ["jbsay", "lafontaine", "musset", "boileau"]},
    classe: {type: String, enum: ["cm2","6eme", "5eme", "4eme", "3eme", "2nde", "1ere", "terminale", "externe"], default:"externe", required: true},
    classeNumber: String,
